...
import com.example.btarekegn.schoolapp.StudentFragment.OnListFragmentInteractionListener;
...
public class MyStudentRecyclerViewAdapter extends RecyclerView.Adapter<MyStudentRecyclerViewAdapter.ViewHolder> {
    ...
    public MyStudentRecyclerViewAdapter(List<User> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mGenderView.setText(mValues.get(position).getGender());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mGenderView = (TextView) view.findViewById(R.id.student_gender_field);
        }

        @Override
        public String toString() {
            return super.toString() + " '" + mContentView.getText() + "'"+ " '" + mGenderView.getText() + "'";
        }
    }
}
